...
Serialcap and hdmicap accept authenticated `POST /stop`. Their helper stop
commands use this endpoint instead of signaling the PID in discovery, avoiding
PID reuse. The request and OS signals enter the same discovery cleanup and exit
path.
