...
> [config-redesign.md](https://github.com/curtisgalloway/paniolo/blob/main/notes/config-redesign.md)). This doc records the original
...
> [distributed-control design](../docs/distributed-control.md) into self-contained,
